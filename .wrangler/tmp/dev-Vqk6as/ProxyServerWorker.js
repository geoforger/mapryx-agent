  ...
  abort(error, trySendAbortMessage = true) {
    ...
    if (trySendAbortMessage) {
      try {
        this.transport
          .send(
            JSON.stringify(["abort", Devaluator.devaluate(error, void 0, this)])
          )
          .catch((err) => {});
      } catch (err) {}
    }
...
// .wrangler/tmp/bundle-00fw42/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-00fw42/middleware-loader.entry.ts
